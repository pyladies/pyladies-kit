...
The ``pyladies`` kit gets you up and running with starting a PyLadies local chapter, including what's needed, advice, event planning help, and some tools that may be helpful.
